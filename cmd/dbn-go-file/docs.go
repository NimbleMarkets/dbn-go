...
var docsCmd = &cobra.Command{
	Use:    "docs",
	Short:  "Generate documentation for dbn-go-file",
	Hidden: true,
	Long: `Generate documentation for all dbn-go-file commands.
...
Examples:
  dbn-go-file docs                                                # Generate markdown docs in ./docs/
  dbn-go-file docs markdown -o ./wiki                             # Generate markdown in custom directory
  dbn-go-file docs markdown --hugo -o docs/hugo/content/command   # Generate Hugo-compatible docs
  dbn-go-file docs man -o docs/man                                # Generate man pages`,
...
var docsMarkdownCmd = &cobra.Command{
	...
	Long: `Generate markdown documentation for all dbn-go-file commands.
...
var docsManCmd = &cobra.Command{
	...
	Long: `Generate man pages for all dbn-go-file commands.
